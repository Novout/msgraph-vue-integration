...
> [!TIP]
> If you prefer to just download the completed tutorial, you can download or clone the [GitHub repository](https://github.com/microsoftgraph/msgraph-training-vue2spa).
...
> [!NOTE]
> This tutorial was written with Node version 12.18.2. The steps in this guide may work with other versions, but that has not been tested.
